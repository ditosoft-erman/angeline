            ...
            <View style={{ backgroundColor: 'white', height: '100%', width: '100%' }}>
                ...
                <View style={{ height: '100%', width: '100%', justifyContent: 'center', paddingTop: 10, paddingBottom: 10 }}>
                    ...
                    {/* <View style={{ alignItems: 'center' }}>
                        <Text style={{ color: 'black', fontWeight: 'bold', letterSpacing: 2, fontSize: 32, marginBottom: 20 }}>
                            Register
                        </Text>
                    </View> */}
                    <View style={{ alignItems: 'center', marginHorizontal: 20 }}>
                        <View  style={{ backgroundColor: '#e8e4c9', padding: 20, borderRadius: 16, width: '100%', marginBottom: 20 }}>
                            <TextInput placeholder="Name" placeholderTextColor={'black'} />
                        </View>
                        <View  style={{ backgroundColor: '#e8e4c9', padding: 20, borderRadius: 16, width: '100%' }}>
                            <TextInput placeholder="Email" placeholderTextColor={'black'} />
                        </View>
                        <View  style={{ backgroundColor: '#e8e4c9', padding: 20, borderRadius: 16, width: '100%', flexDirection: 'row', alignItems: 'center', marginTop: 20 }}>
                            <TextInput
                        ...
                        <View  style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 30 }}>
                            ...
                            <TouchableOpacity onPress={() => navigation.push('Login')}>
                                <Text style={{ color: '#e8e4c9' }}>Login</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
